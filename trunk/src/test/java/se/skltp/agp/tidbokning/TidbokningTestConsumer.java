...
public class TidbokningTestConsumer  extends AbstractTestConsumer<GetSubjectOfCareScheduleResponderInterface> {
	...
	public static void main(String[] args) {
		...
		TidbokningTestConsumer consumer = new TidbokningTestConsumer(serviceAddress, SAMPLE_SENDER_ID, SAMPLE_ORIGINAL_CONSUMER_HSAID);
	...
	public TidbokningTestConsumer(String serviceAddress, String senderId, String originalConsumerHsaId) {
	    
		// Setup a web service proxy for communication using HTTPS with Mutual Authentication
		super(GetSubjectOfCareScheduleResponderInterface.class, serviceAddress, senderId, originalConsumerHsaId);
	}
